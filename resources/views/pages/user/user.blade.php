                ...
                <tr class="bg-gray-800">
                    ...
                    <td class="p-3 rounded-md">
                        <div class="flex align-items-center">
                            <img class="rounded-full h-12 w-12  object-cover" src="{{ asset('storage/'. $user->avatar->src) }}" alt="unsplash image">
                            <div class="ml-3">
                    ...
                    <td class="p-3 rounded-md flex pt-6">
                        ...
                        <a href="/user/{{ $user->id }}/edituser" class="text-gray-400 hover:text-sky-500  mx-2">
                            <i class="material-icons-outlined text-base">edit</i>
                        </a>
                        <form action="/user/{{ $user->id }}" method="POST" class="text-gray-400 hover:text-red-500 mx-2">
                            @csrf
                            @method('DELETE')
                            <button type="submit">
