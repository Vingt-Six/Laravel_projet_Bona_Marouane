            ...
            <tr class="font-semibold">
                ...
                <td class="px-4 py-3 border-b border-pink-500">
                    <a href="/categorie/{{ $categorie -> id }}/edit">
                        <svg width="24" height="24" class="text-sky-500 hover:text-sky-300" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <td class="px-4 py-3 border-b border-pink-500">
                    <form action="/categorie/{{ $categorie -> id }}" method="POST">
                        ...
                        @method('DELETE')
                        <button type="submit">
                            <svg width="24" height="24" class="text-red-600 hover:text-red-300" viewBox="0 0 24 24" fill="none"
