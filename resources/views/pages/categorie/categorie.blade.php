<x-app-layout>
    ...
    <div class="h-[90vh] overflow-scroll bg-gradient-to-t from-rose-200 to-white">
    ...
    <a href="/categorie/create" class="absolute bottom-24 left-[6.5rem]">
        <svg class="text-pink-500 hover:text-pink-700 w-14 h-14" viewBox="0 0 24 24" fill="none"
