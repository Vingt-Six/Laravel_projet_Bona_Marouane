<x-app-layout>
    ...
    <div class="h-[90vh] bg-indigo-100 flex justify-center items-center">
        <div class="lg:w-2/5 md:w-1/2 w-2/3">
            <form class="bg-white p-10 rounded-lg shadow-lg min-w-full" action="/galerie" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div>
                    <label class="text-gray-800 font-semibold block my-3 text-md">Image File</label>
                    <input class="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none" type="file"
                        name="src" />
                </div>
                <button type="submit"
